...
_AWARENESS_TIME = min(int(kegman.conf['wheelTouchSeconds'])+10, 600)    # x minutes limit without user touching steering wheels make the car enter a terminal status
