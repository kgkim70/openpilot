...
EVENTS: Dict[int, Dict[str, Union[Alert, Callable[[Any, messaging.SubMaster, bool], Alert]]]] = {
  ...
  EventName.fanMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("팬 오작동", "Contact Support"),
  },

  EventName.cameraMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("카메라 오작동", "Contact Support"),
  },

  EventName.gpsMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("GPS 오작동", "Contact Support"),
  },

  EventName.localizerMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("Localizer 불안정", "Contact Support"),
  },
  ...
  EventName.brakeHold: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.chimeDisengage),
    ET.NO_ENTRY: NoEntryAlert("브레이크 홀드 활성화"),
  },

  EventName.parkBrake: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.chimeDisengage),
    ET.NO_ENTRY: NoEntryAlert("주차 브레이크 작동"),
  },
  ...
  EventName.belowEngageSpeed: {
    ET.NO_ENTRY: NoEntryAlert("속도가 너무 낮음"),
  },
  ...
  EventName.usbError: {
    ET.SOFT_DISABLE: SoftDisableAlert("USB 오류 : 장치를 재가동하세요"),
    ET.PERMANENT: NormalPermanentAlert("USB 오류 : 장치를 재가동하세요", ""),
    ET.NO_ENTRY: NoEntryAlert("USB 오류 : 장치를 재가동하세요"),
  },
